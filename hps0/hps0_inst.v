	hps0 u0 (
		.bridge_0_acknowledge            (<connected-to-bridge_0_acknowledge>),            //    bridge_0.acknowledge
		.bridge_0_irq                    (<connected-to-bridge_0_irq>),                    //            .irq
		.bridge_0_address                (<connected-to-bridge_0_address>),                //            .address
		.bridge_0_bus_enable             (<connected-to-bridge_0_bus_enable>),             //            .bus_enable
		.bridge_0_byte_enable            (<connected-to-bridge_0_byte_enable>),            //            .byte_enable
		.bridge_0_rw                     (<connected-to-bridge_0_rw>),                     //            .rw
		...
		.hog_in_export                   (<connected-to-hog_in_export>),                   //      hog_in.export
		.hog_out_export                  (<connected-to-hog_out_export>),                  //     hog_out.export
		.switch_out_export               (<connected-to-switch_out_export>),               //  switch_out.export
		.input_pixel_export              (<connected-to-input_pixel_export>)               // input_pixel.export
	);
